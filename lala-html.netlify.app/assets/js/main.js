(function($) {
  ...
  */
  ...
  --------------------------------------------------------------*/
// Chọn phần tử cần thay đổi
var cs_to__right = document.querySelector('.cs-hero__img .cs-to__right');

// Thực hiện sửa đổi thuộc tính transform
cs_to__right.style.transform = 'translateX(400px)'; 
